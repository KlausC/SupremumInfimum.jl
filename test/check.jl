...
@testset "is $x ordered" for (x, y) in
  ((Int, true), (Real, true), (Number, false), (Set{Integer}, true), (BitSet, true),
...
@testset "is $x partially ordered" for (x, y) in
  ((Int, false), (Real, false), (Number, false), (Set{Integer}, true), (BitSet, true),
...
@testset "is $x totally ordered" for (x, y) in
  ((Int, true), (Real, true), (Number, false), (Set{Integer}, false), (BitSet, false),
